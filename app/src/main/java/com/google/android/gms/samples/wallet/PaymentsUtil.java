...
public class PaymentsUtil {
    ...
    private static JSONObject getGatewayTokenizationSpecification() throws JSONException {
        ...
        JSONObject parameters = new JSONObject(Constants.GATEWAY_TOKENIZATION_PARAMETERS);
     ...
     *
     * <p>Please refer to the documentation for more information about DIRECT integration. The type of
